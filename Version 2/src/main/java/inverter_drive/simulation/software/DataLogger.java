...
public class DataLogger {
    ...
    public DataLogger() {
        ...
        logBuffer.add("Time,Va,Vb,Vc,Ia,Ib,Ic,Speed,Torque\n");
    }

    public synchronized void logData(double time, double[] voltages, double[] currents, double speed, double torque) {
        String line = String.format("%.3f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f\n",
