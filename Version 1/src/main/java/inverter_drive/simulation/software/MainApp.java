...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        faultTypeCombo.getItems().addAll("None", "Overcurrent", "Undervoltage", "Phase Loss", "Overheat");
        ...
        thermalGrid.add(new Label("Protection Mode:"), 0, 3);
        thermalGrid.add(thermalProtectionCombo, 1, 3);
